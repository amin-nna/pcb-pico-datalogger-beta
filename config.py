...
# hardware setup
HAVE_PCB     = False                # The Pico is running on the pcb described here: https://github.com/pcb-pico-datalogger
...
HAVE_AHT20   = False        # Sense temperature and humidity with an Adafruit AHT20 sensor connected on I2C bus
HAVE_SHT45   = False      # Sense temperature and humidity with a Adafruit SHT45 sensor connected on I2C bus
HAVE_MCP9808 = False       # Sense temperature with a Adafruit MCP9808 sensor connected on I2C bus
HAVE_LTR559  = False       # Sense light level in lux with a Pimoroni LTR-559 sensor connected on I2C bus
